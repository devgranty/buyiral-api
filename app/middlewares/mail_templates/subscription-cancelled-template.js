const subscriptionCancelledTemplate = (template_vars) => {
    return `<!DOCTYPE html>
    <html lang="en">
        <head>
            <title>Buyiral</title>
        ...
        <body style="padding: 25px 10px;">
            ...
            <div style="max-width: 650px; margin: 30px auto; padding: 20px; border-radius: 2px;">
                <p class="mail-title">We're sorry and we'll miss you</p>
    
                <div>
                    <p>Hi ${template_vars.shop_name},</p>
                    <p>We're sorry to inform you that your Buyiral subscription has been cancelled.</p>
                    <p>But you're always welcome back anytime. To restaet your plan please tap on the button below.</p>
                </div>
    
                <div style="margin: 40px; text-align: center;">
                    <a href="${template_vars.plan_link}" target="_blank" class="link-btn">RESTART PLAN</a>
                </div>
    
                <div style="font-size: 0.8rem; text-align: center;">
                    <span>If you prefer, copy the following link and paste it into your browser to view: </span>
                    <a href="${template_vars.plan_link}" target="_blank">${template_vars.plan_link}</a>
                </div>
            </div>
            <!-- Body -->
...
module.exports = subscriptionCancelledTemplate;