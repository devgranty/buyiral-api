const shopVerificationTemplate = (template_vars) => {
    return `<!DOCTYPE html>
    <html lang="en">
        <head>
            <title>Buyiral</title>
        ...
        <body style="padding: 25px 10px;">
            ...
            <div style="max-width: 650px; margin: 30px auto; padding: 20px; border-radius: 2px;">
                <p class="mail-title">Verify your shop email</p>
    
                <div>
                    <p>To continue access to your shop, we need you to confirm your email address. Please click on the button below to verify your email address.</p>
                </div>
    
                <div style="margin: 40px; text-align: center;">
                    <a href="${template_vars.verify_email_link}" target="_blank" class="link-btn">VERIFY EMAIL</a>
                </div>
    
                <div style="font-size: 0.8rem; text-align: center;">
                    <span>If you prefer, copy the following link and paste it into your browser to view: </span>
                    <a href="${template_vars.verify_email_link}" target="_blank">${template_vars.verify_email_link}</a>
                </div>
...
module.exports = shopVerificationTemplate;