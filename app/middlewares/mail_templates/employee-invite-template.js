const employeeInviteTemplate = (template_vars) => {
    return `<!DOCTYPE html>
    <html lang="en">
        <head>
            <title>Buyiral</title>
        ...
        <body style="padding: 25px 10px;">
            ...
            <div style="max-width: 650px; margin: 30px auto; padding: 20px; border-radius: 2px;">
                <p class="mail-title">New employee invitation from ${template_vars.shop_name}</p>
    
                <div>
                    <p>Hi there,</p>
                    <p>${template_vars.shop_name} is inviting you to come work for them.</p>
                    <p style="font-weight: 500;">How to view and accept invite?</p>
                    <p>To view and accept invite, kindly tap on the link below, create an account with email ${template_vars.email} if you haven't already or sign in into your Buyiral account as ${template_vars.email}, then tap on accept to join ${template_vars.shop_name}.</p>
                </div>
    
                <div style="margin: 40px; text-align: center;">
                    <a href="${template_vars.invite_link}" target="_blank" class="link-btn">VIEW INVITE</a>
                </div>
    
                <div style="font-size: 0.8rem; text-align: center;">
                    <span>If you prefer, copy the following link and paste it into your browser to view: </span>
                    <a href="${template_vars.invite_link}" target="_blank">${template_vars.invite_link}</a>
                </div>
...
module.exports = employeeInviteTemplate;